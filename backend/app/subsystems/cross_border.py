# Cross-border transmission corridor layer
# Unofficial border crossing points derived from terrain analysis +
# traditional transhumance routes + IOM monitoring data.
